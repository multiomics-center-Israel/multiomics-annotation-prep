#' Shared GMT helpers (vendored)
#'
#' Self-contained copies of the GMT read/write/validate/filter/generate helpers
#' the builder scripts in this folder rely on. Vendored from multiomics-core
#' (R/core/13_gmt_utils.R and read_gmt from R/core/09_enrichment.R) so this repo
#' can build GMTs without depending on the pipeline source tree. Keep the two in
#' sync if the core helpers change.
